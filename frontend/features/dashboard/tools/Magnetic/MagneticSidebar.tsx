...
import { Plus, X, Calendar, User, Repeat } from "lucide-react";
  ...
  return (
    <div className="h-full w-full border-r border-[#D1D5DB] bg-[#F2F4F7] flex flex-col w-80 shrink-0">
      ...
      <div className="flex-1 overflow-y-auto p-4">
        {/* Could list quick filters or stats here */}
        {isOpen && (
          <div className="bg-[#1B264F]/20 border border-[#D1D5DB]/20 rounded-lg p-4 mb-4">
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <div className="flex items-center px-3 py-2 bg-[#2C2E33] rounded border border-[#D1D5DB]/20">
              ...
              <div>
                ...
                <div className="flex items-center px-3 py-2 bg-[#F2F4F7] rounded border border-[#D1D5DB] focus-within:border-[#1B264F] transition-colors">
                  <Calendar className="w-4 h-4 text-[#8E9299] mr-2" />
                  <input
                    type="date"
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-[#F2F4F7] border border-[#D1D5DB] rounded px-2 py-2 text-xs text-[#2C2E33] focus:outline-none focus:border-[#1B264F]"
                  >
