    ...
    >
      ...
      <div className="w-full h-full p-4 md:p-8 lg:p-12 grow flex flex-col">
        <div className="grid grid-cols-1 md:grid-cols-12 md:grid-rows-10 md:h-full overflow-hidden rounded-3xl">
          <div className="md:col-span-6 md:row-start-1 md:row-span-4 w-full h-auto md:h-full p-4 order-2 md:order-none overflow-hidden bg-black bg-tech-dots flex flex-col justify-center">
          ...
          <div className="md:col-start-7 md:col-span-6 row-start-1 md:row-end-9 md:h-full relative z-10 flex items-end justify-end">
            <img
              src={aesImage}
              className="brightness-90 absolute inset-0 w-full h-full object-cover opacity-100 group-hover:scale-110 transition-all duration-700"
              alt="Aesthetic"
            />
          </div>
          {/* NAME BLOCK  */}
          <div className="md:col-start-4 md:col-span-5 md:row-start-5 md:row-span-4 bg-black z-20 flex flex-col border-r-2 border-t-2 border-t-white order-3 md:order-none overflow-hidden relative p-4">
          ...
          <div className="grid grid-cols-2 md:contents order-4 md:order-none ">
            <div className="md:col-span-3 md:row-start-5 md:row-span-2 border-t-2 border-r-2 bg-tech-dots">
            ...
            <div className="md:col-span-3 md:row-start-7 md:row-span-2 p-4 font-kumar flex items-end border-t-2 border-r-2 bg-tech-dots">
              <AnimatedText
                text="FRONTEND"
          ...
          {/* MARQUEE FOOTER */}
          <div className="md:col-span-12 md:row-start-9 md:row-span-3 text-5xl font-bold flex items-center justify-center border-t-2 min-h-[100px] order-5 md:order-none">
            <Marquee
              gradient={false}
              speed={40}
              direction="left"
